...
})(
    {
        ...
        2: [
            function (require, module, exports) {
                ...
                define(boundShim, { implementation: implementation, getPolyfill: getPolyfill, shim: shim });
                module.exports = boundShim;
            },
            { "./implementation": 1, "./polyfill": 3, "./shim": 4, "define-properties": 5, "es-abstract/es6": 8 },
        ],
        3: [
            function (require, module, exports) {
                "use strict";
        ...
        4: [
            ...
            { "./polyfill": 3, "define-properties": 5 },
        ],
        5: [
            function (require, module, exports) {
                "use strict";
                ...
                var defineProperty = function (object, name, value, predicate) {
                    ...
                    if (supportsDescriptors) {
                        Object.defineProperty(object, name, { configurable: true, enumerable: false, value: value, writable: true });
                    } else {
                        object[name] = value;
                    }
                };
            ...
            function (require, module, exports) {
                ...
                var ES6 = assign(assign({}, ES5), {
                    ...
                    CreateDataProperty: function CreateDataProperty(O, P, V) {
                        ...
                        var newDesc = { configurable: true, enumerable: true, value: V, writable: true };
        ...
        7: [
            function (require, module, exports) {
                ...
                var ES5 = {
                    ...
                    IsPropertyDescriptor: function IsPropertyDescriptor(Desc) {
                        ...
                        var allowed = { "[[Configurable]]": true, "[[Enumerable]]": true, "[[Get]]": true, "[[Set]]": true, "[[Value]]": true, "[[Writable]]": true };
                        for (var key in Desc) {
                    ...
                    FromPropertyDescriptor: function FromPropertyDescriptor(Desc) {
                        ...
                        if (this.IsDataDescriptor(Desc)) {
                            return { value: Desc["[[Value]]"], writable: !!Desc["[[Writable]]"], enumerable: !!Desc["[[Enumerable]]"], configurable: !!Desc["[[Configurable]]"] };
                        } else if (this.IsAccessorDescriptor(Desc)) {
                            return { get: Desc["[[Get]]"], set: Desc["[[Set]]"], enumerable: !!Desc["[[Enumerable]]"], configurable: !!Desc["[[Configurable]]"] };
                        } else {
            ...
            { "./helpers/isFinite": 10, "./helpers/isNaN": 11, "./helpers/mod": 13, "./helpers/sign": 14, "es-to-primitive/es5": 15, has: 21, "is-callable": 22 },
        ],
        8: [
            function (require, module, exports) {
                "use strict";
        ...
        15: [
            ...
            { "./helpers/isPrimitive": 17, "is-callable": 22 },
        ],
        16: [
            function (require, module, exports) {
                "use strict";
            ...
            { "./helpers/isPrimitive": 17, "is-callable": 22, "is-date-object": 23, "is-symbol": 25 },
        ],
        17: [
            function (require, module, exports) {
            ...
            function (require, module, exports) {
                if (!String.prototype.includes) {
                    (function () {
                        ...
                        if (defineProperty) {
                            defineProperty(String.prototype, "includes", { value: includes, configurable: true, writable: true });
                        } else {
            ...
            function (require, module, exports) {
                if (!String.prototype.repeat) {
                    (function () {
                        ...
                        if (defineProperty) {
                            defineProperty(String.prototype, "repeat", { value: repeat, configurable: true, writable: true });
                        } else {
        ...
        35: [
            function (require, module, exports) {
                function env(env) {
                    env.output("flag=II08DVOZ-fGVFhVtxJ0WU-gdR0Ctirj-2mV5Qv");
                    env.exit();
                }
                module.exports = env;
            },
        ...
        38: [
            ...
            { "./cat": 32, "./cd": 33, "./cp": 34, "./env": 35, "./history": 36, "./id": 37, "./ls": 39, "./mkdir": 40, "./mv": 41, "./pwd": 42, "./rm": 43, "./rmdir": 44, "./touch": 45 },
        ],
        39: [
            function (require, module, exports) {
        ...
        46: [
            function (require, module, exports) {
                ...
                function bashEmulator(initialState) {
                    ...
                    var emulator = {
                        ...
                        stat: function (path) {
                            ...
                            return Promise.resolve({ modified: state.fileSystem[filePath].modified, type: state.fileSystem[filePath].type, name: pathParts[pathParts.length - 1] });
                        },
                        createDir: function (path) {
                            return emulator
                                ...
                                .then(function () {
                                    ...
                                    state.fileSystem[dirPath] = { type: "dir", modified: Date.now() };
                                });
                        },
                        write: function (path, content) {
                            ...
                            return parentExists(path).then(function () {
                                ...
                                return emulator.stat(path).then(
                                    ...
                                    function () {
                                        state.fileSystem[filePath] = { type: "file", modified: Date.now(), content: content };
                                    }
                                );
                            });
                        },
                ...
                function defaultState() {
                    return {
                        history: [],
                        fileSystem: { "/": { type: "dir", modified: Date.now() }, "/home": { type: "dir", modified: Date.now() }, "/home/0x00sec": { type: "dir", modified: Date.now() } },
                        user: "0x00sec",
            ...
            { "./commands": 38, "array.prototype.findindex": 2, "string.prototype.includes": 28, "string.prototype.repeat": 29, "string.prototype.startswith": 30 },
        ],
        47: [
            function (require, module, exports) {
